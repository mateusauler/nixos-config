...
let
  ...
  generateTextMateTheme = { scheme, indentPattern ? "  ", extraXmlConfig ? null }:
    let
      toXml = expr:
        let
      ...
      colorsDict = with scheme; with colors; {
        name = "Generated base16 theme based on ${slug}";
        semanticClass = "theme.base16.${slug}";
        colorSpaceName = "sRGB";
        gutterSettings = {
          background = "#${base01}";
          divider = "#${base01}";
